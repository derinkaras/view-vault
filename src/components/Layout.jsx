...
export default function Layout(props){
    ...
    const header = (
        <header className="flex justify-between items-center relative">
            ...
            <button 
                className="text-inherit flex items-center gap-2 hover:cursor-pointer bg-[#15182b] dark:bg-[#05070f] w-fit font-medium px-2 py-2 border-[1.5px] border-[#323c71] dark:border-[#323c71] rounded-md shadow-[2px_2px_0px_0px_#323c71] dark:shadow-[2px_2px_0px_0px_#323c71] transition-all duration-200 hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] disabled:opacity-55 disabled:hover:shadow-[2px_2px_0px_0px_#323c71] dark:disabled:hover:shadow-[2px_2px_0px_0px_#323c71] disabled:hover:translate-x-0 disabled:hover:translate-y-0 disabled:cursor-default"                onClick={()=>{globalUser ? logout(): setIsModal(true)}}
            >
                <p className="font-bold"> {globalUser ? "Logout" : "Sign up free"}</p>
